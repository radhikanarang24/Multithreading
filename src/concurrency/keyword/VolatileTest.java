    ...
    public static void main(String[] args)
    {
       ...
       // new ChangeMaker().start();
        ...
        Thread flagChanger = new Thread(new Runnable() {
            @Override
            public void run() {
                System.out.println("The value of flag is : "+volatileTest.flag+" for thread Name "+
                        Thread.currentThread().getName()+" at time "+System.currentTimeMillis());
                volatileTest.flag=true;
                System.out.println("The value of flag is updated to : "+volatileTest.flag+" by thread Name "+
                        Thread.currentThread().getName()+" at time "+System.currentTimeMillis());
            }
        });
        ...
        Thread flagListener = new Thread(new Runnable() {
            ...
            public void run() {
               /* try {
                ...
                System.out.println("The value of flag is updated to : "+volatileTest.flag+"  thread Name "+
                        Thread.currentThread().getName()+" at time "+System.currentTimeMillis());
            }
        });
